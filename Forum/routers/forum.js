...
router.get ('/posts',checkAuth, controllerForum.getPosts) // Ruta para obtener todas las publicaciones
router.get ('/:username', controllerForum.getPostsByUsername)
router.post ('/create',checkAuth, controllerForum.createPost) // Ruta para crear una nueva publicación, con verificación de token
